...
export class TiposComponentesService {
  ...
  getTipComponentes(): Observable<{ 
    ...
    return this.http.get<{ error: boolean, msg: string, data: any }>(
      API_ROUTES.CONSULT.CONSULT_TIP_COMP,
  ...
  /**
   * SERVICIO QUE INGRESA EL TIPO DE COMPONENTE
   * @param data 
   * @returns 
   */
  insertTipComp(data: any): Observable<{ 
      error: boolean, 
      msg: string, 
      data: any 
  }> {
    ...
    return this.http.post<{ error: boolean, msg: string, data: any }>(
      API_ROUTES.INSERT.INSERT_TIP_COMP,
   ...
   */
   updateTipComp(id:number, data: any): Observable<{ 
    error: boolean, 
    msg: string, 
    data: any 
  }> {
    ...
    formData.set('tipocomponenteid', id.toString());
  
    const response = { error: true, msg: 'Error al insertar los datos.', data: null };
  
    return this.http.post<{ error: boolean, msg: string, data: any }>(
      API_ROUTES.UPDATE.UPDATE_TIP_COMP,
      formData.toString(), // Convertir los datos a una cadena de texto
      httpOptions
    ).pipe(
      map(r => {
